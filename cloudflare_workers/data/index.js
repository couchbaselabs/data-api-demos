 ...
 */
 const apiHost = 'https://api.couchbase.live';
 const apiVersion = '/v0.1-alpha/api';
 //const url = apiHost + apiVersion+ '/buckets/travel-sample/scopes/_default/collections/_default/docs';
 ...
 async function handleRequest(request) {
   ...
   url = apiHost + apiVersion +'/buckets/'+bucket+'/scopes/'+scope+'/collections/'+collection+'/docs';
    queryParams = '?';
